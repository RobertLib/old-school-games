...
export function startRateLimitPruning(): void {
  ...
  // Once now as well as on the interval, for the reason index.ts gives for
  // pruneExpiredData: machines here are stopped when idle and started on
  // demand, and one that never lives ten minutes never swept anything.
  void prune();
