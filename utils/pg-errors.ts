/**
 * Postgres SQLSTATE for a foreign-key violation. Not exported: the one
 * question anybody asks of it is the one below, and a bare code exported
 * beside a predicate only invites a second, hand-rolled copy of that check.
 */
