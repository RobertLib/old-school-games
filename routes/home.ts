...
router.get("/:genre", async (req, res, next) => {
  ...
  const description = `Explore classic MS-DOS games in the ${genre} genre. Play retro games from this genre online.`;
...
router.get("/developer/:developer", async (req, res, next) => {
  ...
  const description = `Explore classic MS-DOS games developed by ${developer}. Play retro games from this developer online.`;
...
router.get("/publisher/:publisher", async (req, res, next) => {
  ...
  const description = `Explore classic MS-DOS games published by ${publisher}. Play retro games from this publisher online.`;
