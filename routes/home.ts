...
router.get("/:genre", async (req, res, next) => {
  ...
  const description = `Explore classic MS-DOS games in the ${genre} genre. Play games from this genre online.`;
...
router.get("/developer/:developer", async (req, res, next) => {
  ...
  const description = `Explore classic MS-DOS games developed by ${developer}. Play games from this developer online.`;
...
router.get("/publisher/:publisher", async (req, res, next) => {
  ...
  const description = `Explore classic MS-DOS games published by ${publisher}. Play games from this publisher online.`;
...
router.get("/year/:year", async (req, res, next) => {
  ...
  res.render("index", {
    ...
    description: `Browse MS-DOS games released in ${yearNum}. Play classic games from this year online.`,
  });
});
...
router.get("/:id", async (req, res, next) => {
  ...
  const title = `${game.title} - Play classic MS-DOS Games Online on OldSchoolGames`;
  const description = `Play ${game.title} online for free! This classic ${game.genre ? game.genre.toLowerCase() : "MS-DOS"} game${game.release ? ` from ${game.release}` : ""}${game.developer ? ` by ${game.developer}` : ""} brings back nostalgic retro gaming memories. Experience authentic DOS gaming in your browser with no downloads required. Join thousands of retro gaming enthusiasts playing classic MS-DOS games on OldSchoolGames.`;
