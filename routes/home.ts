...
router.get("/developer/:developer", async (req, res, next) => {
  ...
  const description = `Explore classic MS-DOS games developed by ${developer}. Play authentic retro games from this legendary developer directly in your browser with DOSBox emulation - no downloads required.`;
...
router.get("/:id", async (req, res, next) => {
  ...
  // Plain-text game description for structured data (strip HTML tags)
